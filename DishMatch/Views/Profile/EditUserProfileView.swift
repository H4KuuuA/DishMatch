...
struct EditUserProfileView: View {
        ...
        NavigationStack {
            ...
            .onChange(of: selectedPhotoItem) { _, newItem in
                Task {
                    ...
                    pendingAvatarData = Self.resizedJPEGData(from: data)
                }
            }
        }
    }
    ...
    /// 長辺をmaxDimensionに抑えたJPEGにリサイズする。UserDefaultsに保存するため容量を絞っている
    private static func resizedJPEGData(from data: Data, maxDimension: CGFloat = 480, compressionQuality: CGFloat = 0.75) -> Data? {
